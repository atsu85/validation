declare module 'aurelia-validation' {
  ...
  export class TWBootstrapViewStrategyBase extends ValidationViewStrategy {
    ...
    constructor(appendMessageToInput: boolean, appendMessageToLabel: boolean, helpBlockClass: string, formGroupClass?: any, validationMsgTagName?: any);
    ...
    findExistingHelpBlock(element: Element): any;
    addHelpBlockToElement(element: Element, helpBlock: Element): any;
